...
const whatYouGetBg = "/src/assets/images/WhatYouGetBGImage.jpg";
...
export default function PartnerSystem() {
  ...
  return (
    ...
    >
      ...
      {/* Subtle blue tint */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#00141C]/70 via-black/30 to-black/80" />
      ...
      <div className="relative z-10 py-24 md:py-32">
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-[#E5E5E5] text-[16px] leading-[1.6] max-w-xl">
          ...
          {/* Pillar navigation */}
          <div className="mt-14 -mx-6 px-6 overflow-x-auto md:overflow-visible [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              ...
              {PILLARS.map((pl, i) => {
                ...
                return (
                  <button
                    key={pl.n}
                    onClick={() => setActive(i)}
                    className={`relative shrink-0 md:shrink rounded-xl border px-5 py-5 text-left transition-all duration-300 min-w-[150px] md:min-w-0 ${
                      on
          ...
          <div className="relative mt-6 rounded-2xl border border-white/10 bg-black/65 backdrop-blur-sm p-8 md:p-12 overflow-hidden">
            <span
              aria-hidden
              className="pointer-events-none absolute -right-6 -bottom-10 font-display font-black text-[160px] md:text-[220px] leading-none text-white/[0.03] select-none"
            >
              {p.n}
            </span>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div>
                  ...
                  <span className="block mt-3 font-display font-black text-6xl md:text-7xl text-[#29ABE2] leading-none">
                    {p.n}
                  </span>

                  <h3 className="mt-5 font-display uppercase font-black text-white text-3xl md:text-4xl tracking-[-0.02em] leading-[1.02]">
                    {p.title}
                  </h3>
