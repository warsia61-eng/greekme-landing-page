        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 w-full">
              {/* Replace the CTA buttons container in Opportunity.jsx */}
              <a
                href="#system"
                className="w-full flex items-center justify-center rounded-full border border-[#29ABE2] bg-[#29ABE2]/10 py-4 px-6 text-xs font-bold uppercase tracking-[0.14em] text-[#29ABE2] transition-all hover:bg-[#29ABE2] hover:text-black active:scale-[0.98]"
              >
              ...
              <a
                href="#menu"
                className="w-full flex items-center justify-center rounded-full border border-white/20 bg-white/5 py-4 px-6 text-xs font-bold uppercase tracking-[0.14em] text-white transition-all hover:border-[#29ABE2] hover:text-[#29ABE2] active:scale-[0.98]"
              >
                EXPLORE THE MENU
              </a>
</div>
