...
const QA = [
  ["What is the royalty model?", "GreekME operates on a revenue-based royalty. Instead of a fixed monthly franchise fee, partners pay a royalty linked to business performance—so GreekME succeeds when you succeed."],
  ...
  ["What does the royalty cover?", "The royalty covers use of the GreekME brand, menu, recipes, kitchen playbooks, training, marketing assets, and ongoing partner support. Royalty terms are discussed during the partnership process."],
  ...
  ["Do I need a commercial kitchen?", "Yes. GreekME runs inside a licensed commercial or cloud kitchen. If you don't have one yet, we can advise on shared kitchen options."],
  ...
  ["Can I operate other brands from my kitchen?", "Yes. GreekME is designed as a multi-brand friendly concept that shares equipment and staff with your existing operation."],
  ...
  ["How does the application process work?", "Submit an enquiry, confirm your kitchen and details, receive the brand kit and playbook, train your team, then launch on your delivery platforms with ongoing GreekME support."],
];
